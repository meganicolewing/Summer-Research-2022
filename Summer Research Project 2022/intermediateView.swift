                ...
                .overlay(
                    GeometryReader { geometry in
                        ...
                        ForEach(0..<rectangleStruct.rectangles1Left.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles1Left[index].minX *  geometry.size.width, //+ 6,
                                y: rectangleStruct.rectangles1Left[index].minY *  geometry.size.height,// + 2,
                        ...
                        ForEach(0..<rectangleStruct.rectangles1Right.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles1Right[index].minX *  geometry.size.width,// - 6,
                                y: rectangleStruct.rectangles1Right[index].minY *  geometry.size.height,// + 2,
                        ...
                        ForEach(0..<rectangleStruct.rectangles2Left.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles2Left[index].minX *  geometry.size.width,// + 6,
                                y: rectangleStruct.rectangles2Left[index].minY *  geometry.size.height,// + 2,
                    ...
                    GeometryReader { geometry in
                        ForEach(0..<rectangleStruct.rectangles2Right.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles2Right[index].minX *  geometry.size.width,// - 6,
                                y: rectangleStruct.rectangles2Right[index].minY *  geometry.size.height,// + 2,
                        ...
                        ForEach(0..<rectangleStruct.rectangles3Left.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles3Left[index].minX * geometry.size.width,// + 6,
                                y: rectangleStruct.rectangles3Left[index].minY * geometry.size.height,// + 2,
                        ...
                        ForEach(0..<rectangleStruct.rectangles3Right.count){ index in
                            Rectangle()
                                .path(in: CGRect(
                                x: rectangleStruct.rectangles3Right[index].minX *  geometry.size.width,// - 6,
                                y: rectangleStruct.rectangles3Right[index].minY *  geometry.size.height,// + 2,
